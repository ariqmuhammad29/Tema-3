...
use App\Http\Controllers\Admin\Partner\ChangeOrderController as PartnerChangeOrderController;
...
use App\Http\Controllers\Admin\daftar\daftarController;
use App\Http\Controllers\Admin\Award\AwardController;
...
Route::group(['prefix' => 'admin-panel', 'as' => 'admin.'], function () {
    ...
    Route::middleware('auth:web', 'permission:admin access')->group(function () {
        ...
        Route::name('product.')->group(function () {
            Route::resource('product/categories', ProductCategory::class);
            Route::resource('product/posts', ProductPost::class);
        });
        Route::resource('partners', PartnerController::class);
        Route::get('partners/{partners}/change-order/{arrow}', [PartnerChangeOrderController::class, 'update'])
            ->name('partners.change-order');
