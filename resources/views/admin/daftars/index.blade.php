                        ...
                        <td>
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 34px, 0px); top: 0px; left: 0px; will-change: transform;">
                                    <a class="dropdown-item" href="{{ route('admin.daftars.edit', $model->id) }}">Reply</a>
                                    <form action="{{ route('admin.daftars.destroy', $model->id) }}" method="post">
                                        {{ csrf_field() }}
                                        {{ method_field('delete') }}
