        ...
        <div class="card-body">
            ...
            <form class="form-horizontal" action="{{ route('admin.services.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <input class="form-control" id="title" size="16" type="text" name="title" placeholder="Title of the service" value="{{ old('title') }}" required>                        
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <textarea class="form-control" id="desc_sort" name="description_short" cols="30" rows="10" placeholder="Short Description of the service" required>{{ old('description') }}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <textarea class="form-control" id="desc" name="description" cols="30" rows="10" style="min-height: 60px;" placeholder="Description of the service" required>{{ old('description') }}</textarea>
                    </div>
                </div>
                <div class="form-group">
