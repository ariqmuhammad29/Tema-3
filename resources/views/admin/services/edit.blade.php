    ...
    <div class="card">
        <div class="card-body">
            ...
            @if ($errors->any())
                ...
                @endforeach
            @endif
            <form class="form-horizontal" action="{{ route('admin.services.update', $model->id) }}" method="post" enctype="multipart/form-data" id="form-posts" >
                {{ method_field('put') }}
                {{ csrf_field() }}
                <div class="form-group">
                    <label class="col-form-label" for="title">Title</label>
                    <div class="controls">
                        <input class="form-control" id="title" size="16" type="text" name="title" placeholder="Title of the service" value="{{ $model->title }}" required>
                ...
                <div class="form-group">
                  ...
                  <div id="description" style="min-height: 60px;">{!! @$model->description !!}</div>
