...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item">{{ $partner->name }}</div>
                ...
                <div class="row">
                    <div class="col-md">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input class="form-control" id="name" size="16" type="text" name="name" value="{{ old('name') ?: $partner->name }}" placeholder="Name">
                            </div>
                        </div>
                    <div class="col-md">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <textarea class="form-control" id="desc" name="about" cols="30" rows="10" style="min-height: 60px;" placeholder="About">{{ old('about') ?: $partner->about }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="d-flex">
                                <img 
                                    src="{{ @$partner->image->sm ?? asset('static/admin/img/default.png') }}" alt="photo">
