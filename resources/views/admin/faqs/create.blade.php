        ...
        <div class="card-body">
            ...
            <form class="form-horizontal" action="{{ route('admin.faqs.store') }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <input class="form-control" id="question" size="16" type="text" name="question" placeholder="question" value="{{ old('question') }}" required>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-form-label" for="answer">answer</label>
                    <div class="controls">
                        <textarea class="form-control" id="desc" name="answer" cols="30" rows="10" style="min-height: 60px;" placeholder="answer" required>{{ old('answer') }}</textarea>
                    </div>
                </div>
