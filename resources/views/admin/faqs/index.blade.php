...
<section class="section">
    ...
    <div class="card">
        <div class="card-header">
            <a href="{{ route('admin.faqs.create') }}" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add
                Category Article</a>
        </div>
        <div class="card-body">
                        ...
                        <td>
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu" x-placement="bottom-start"
                                    ...
                                    <a class="dropdown-item" href="{{ route('admin.faqs.edit', $d->id) }}">Edit</a>
                                    <form action="{{ route('admin.faqs.destroy', $d->id) }}" method="post">
                                        {{ csrf_field() }}
                                        {{ method_field('delete') }}
