<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            @if(auth()->user()->hasAnyPermission(['sliders read', 'clients read', 'services read', 'keunggulan read', 'teams read', 'testimoni read', 'menu read', 'submenu read']) or auth()->user()->hasRole('superadmin'))
            <li class="nav-item dropdown @if (@$menuActive === 'landing-page') active @endif">
                ...
                <ul class="dropdown-menu">
                    ...
                    @endcan
                    @can('partners read')
                    <li class="@if (@$subMenuActive === 'partners') active @endif">
                    ...
                    @endcan
                    @can('faqs read')
                    <li class="@if (@$subMenuActive === 'faqs') active @endif">
                    ...
                    @endcan
                    @can('benefits read')
                    <li class="@if (@$subMenuActive === 'benefits') active @endif">
                    ...
                    @endcan
                    @can('steps read')
                    <li class="@if (@$subMenuActive === 'steps') active @endif">
                        <a class="nav-link" href="{{ route('admin.steps.index') }}">
                        steps
                        </a>
                    </li>
                    @endcan
            ...
            <!-- pengerjaan about us -->
            @if(auth()->user()->hasAnyPermission(['product awards read', 'product posts read']) or auth()->user()->hasRole('superadmin'))
            <li class="nav-item dropdown @if (@$menuActive === 'product') active @endif">
                <a class="nav-link has-dropdown" href="#">
                    <i class="far fa-file-alt"></i>
                    <span>about us</span>
                ...
                <ul class="dropdown-menu">
                    ...
                    <!-- dari sini -->
                    @can('awards read')
                    <li class="@if (@$subMenuActive === 'awards') active @endif">
            ...
            <!-- pengerjaan about us -->
            @if(auth()->user()->hasAnyPermission(['product courses read', 'product posts read']) or auth()->user()->hasRole('superadmin'))
            <li class="nav-item dropdown @if (@$menuActive === 'product') active @endif">
                <a class="nav-link has-dropdown" href="#">
                    <i class="far fa-file-alt"></i>
                    <span>service</span>
                ...
                <ul class="dropdown-menu">
                    ...
                    <!-- dari sini -->
                    @can('courses read')
                    <li class="@if (@$subMenuActive === 'courses') active @endif">
            ...
            <li class="nav-item dropdown @if (@$menuActive === 'inboxes') active @endif">
                ...
                <ul class="dropdown-menu">
                    ...
                    @endcan
                    @can('daftars read')
                    <li class="nav-item @if (@$subMenuActive === 'daftars') active @endif">
                        <a class="nav-link" href="{{ route('admin.daftars.index') }}">
                            <span>daftars</span>
                        </a>
                    </li>
                    @endcan
